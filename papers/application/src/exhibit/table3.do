...
esttab model1 model2 model3 model4 model5 model6 using "papers/application/table/table3.tex", ///
...
display "Table 3 generated: papers/application/table/table3.tex"