...
\subsection{Second moment biases}
\label{subsec:variance_bias}

\textbf{Bias in the variance.} The noise in the estimated CEO-spell change is the difference between
