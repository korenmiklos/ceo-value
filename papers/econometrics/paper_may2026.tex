...
$t$. In our application, we use three alternative measures: log
...
a portable person effect that follows the CEO across firms. Most CEOs
in our data are observed at only one firm, and we do not use mobility
...
This is the source of the small-sample problem. Even when the number of
...
\begin{table}[H]
    \centering
    \caption{OLD Company Characteristics}
    \vspace{.2cm}
    \label{tab:table_firm_desc}
    \begin{tabular}{lcccc}
