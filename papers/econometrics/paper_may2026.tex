...
WE SHOULD SHOW R2 HERE AS WELL
...
the average firm-level shocks in spells $s$ and $s-1$.\footnote{For formal derivations of the biases, see Appendix \ref{sec: appA}.} Let the variance
