...
We compute all contrasts relative to the year before the CEO arrival ($t=-1$), which elminates the firm fixed effect.\footnote{If a firm has more than two consecutive spells, we treat adjacent spell pairs as separate transitions; multiple transitions per firm are allowed but clustered at the firm level.}
