...
\toprule
 & \textbf{Baseline} & \textbf{Long Panel} & \textbf{Persistent Errors} & \textbf{Unbalanced Panel} & \textbf{Excess Variance} & \textbf{All Complications} \\
\midrule
$N_{\text{treated}}$ & \multicolumn{6}{c}{10,000} \\
$N_{\text{control}}$ & \multicolumn{6}{c}{90,000} \\
