...
This statistic is the core object in variance decompositions; by theory and by Monte Carlo, its variance is upward biased in short panels and under persistence, which motivates our placebo debiasing.[[I do not get this sentence.]]
...
[[We should drop the following paragraphs until the results]]
...
%% are we deleting this or not? 
%we should, or we should edit it and place to the beginning of the section, but we dont have time
%% ok, lets drop, we are over length
