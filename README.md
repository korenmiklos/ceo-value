...
| `temp/largest_component_managers.csv` | Derived | Manager IDs in largest connected component | Generated by code |
...
- Stata (code was last run with version 18.0)
  - Required package: reghdfe (version 6.12.5 27Dec2023)
...
- `temp/largest_component_managers.csv` depends on `code/create/connected_component.jl` and edgelist data
